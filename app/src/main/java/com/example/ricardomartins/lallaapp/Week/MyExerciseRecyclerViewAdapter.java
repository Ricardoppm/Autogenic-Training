...
import com.example.ricardomartins.lallaapp.Week.ExerciseFragment.OnListFragmentInteractionListener;
...
public class MyExerciseRecyclerViewAdapter extends RecyclerView.Adapter<MyExerciseRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if(mValues.get(position).Bmorning){
            ...
            holder.BtMorning.setImageResource( R.drawable.m_green);
        }else{ holder.BtMorning.setImageResource( R.drawable.m_red); }
        if(mValues.get(position).Bafternoon){
            Log.i("List", "Change afternoon to green");
            holder.BtAnoon.setImageResource( R.drawable.a_green);
        }else{ holder.BtAnoon.setImageResource( R.drawable.a_red); }
        if(mValues.get(position).Bnight){
            Log.i("List", "Change night to green");
            holder.BtNight.setImageResource( R.drawable.n_green);
        }else{ holder.BtNight.setImageResource( R.drawable.n_red); }
